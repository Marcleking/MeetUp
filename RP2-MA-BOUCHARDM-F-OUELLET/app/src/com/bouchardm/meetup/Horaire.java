...
public class Horaire extends ListActivity {
	/**
	...
	{
		View ajoutHoraire = getLayoutInflater().inflate(R.layout.horaire_ajout, null);
	...
	public class LigneAdapter extends ArrayAdapter<String> {
		 ...
		 */
		public LigneAdapter() {
			super(Horaire.this, R.layout.horaire_ligne, R.id.lbl_content, m_Tokens);
		}
