...
public class MeetUp extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.meet_up_accueil);
	...
	{
		this.startActivity(new Intent(this, CreationMeetUp.class));
	}
	...
	public class LigneAdapter extends ArrayAdapter<String> {
		 ...
		 */
		public LigneAdapter() {
			super(MeetUp.this, R.layout.meet_up_ligne, R.id.lblMeetUp, m_Tokens);
		}
