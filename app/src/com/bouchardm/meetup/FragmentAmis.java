...
public class FragmentAmis extends Fragment implements View.OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.btnAjoutGroupe = (Button)rootView.findViewById(R.id.btnAjoutAmi);
		...
		if (type == ExpandableListView.PACKED_POSITION_TYPE_CHILD)
		{
			...
			switch(item.getItemId())
			{
				...
				case R.id.menu_changerGroupe:
					//On demande à l'utilisateur dans quel groupe il veut envoyer sont ami
